...
class BlendertoVsiticherPanel(bpy.types.Panel):
    ...
    bl_label = "VStitcher2BlendTool"
    bl_idname = "MATCNUP_PT_PANEL"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "VStitcher2Blend"
...
class Help(bpy.types.Operator):
    ...
    def execute(self, context):
        webbrowser.open("https://www.kaylaman.com/vstitcher2blend-tool.html")
        return {"FINISHED"}
class PBR_SHADER(bpy.types.Operator):
    ...
    def execute(self,context):    
        ...
        activeObject.data.materials[0] = mat_pbr
